...
**cast** is a word that we use a lot. To cast a pattern can mean:
 ⟜ writing a file
 ⟜ executing a command directly using bash or an exectable
 ⟜ instructing a backgrounded worker
 ⟜ to gather together information 

example
 
> Can you look for content that reminds you of any of the rows in this [range deck] and [categorize|list|elaborate] them using the rows of this deck into branches.

# cast

cast ⟜ everyday meanings
