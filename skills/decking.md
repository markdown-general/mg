...
Decking emerges from prose. It doesn't impose rigid structure—it surfaces what's already there.

**minimal**
idea ⟜ elaboration

**inline**
idea ⟜ first thought, second thought, third thought

**nested**
idea ⟜ primary elaboration
- supporting point
- another support
~ contrasting view

**flowing**
We talk about ideas. Sometimes one idea **leads** into another, and we elaborate with a dash of detail—or a comma, naturally flowing between structure and prose. The boundaries blur.

## avoid blocky deck syndrome
...
Sometimes it's:
- Just prose
- **One bold lead** followed by natural sentences
- A paragraph where the structure is implicit
- Mixed modes that feel right

## compression examples

**verbose**
The process of identifying and removing unnecessary elements while preserving the essential meaning and core relationships

**compressed**
**prune** ⟜ remove fuzzy edges, preserve core meanings

**over-compressed**
**prune** ⟜ cut

(The middle one has the right density.)
...
**sprouting**
**thinking tools** ⟜ help organize ideas

**branching**
**thinking tools** ⟜ notations for organizing thought
- decking for structure
- prose for flow
~ rigid templates constrain
+ flexible patterns guide

**maybe too much?**
**thinking tools** ⟜ formal and informal notations designed to support cognitive processes related to organizing, structuring, and expressing ideas
- decking provides hierarchical organization through typed elaborations
- prose enables natural expression with implicit structure
- templates can become overly prescriptive when applied rigidly
~ excessive formalization may inhibit spontaneous thought
~ insufficient structure may result in disorganization
+ balance between structure and flexibility yields optimal results

(That last one lost its soul. Cut 50%.)

## bidirectional flow

**prose → deck**
Find the leads. What elaborates what? Which words carry weight? Compress.

**deck → prose**
Let the structure dissolve. Leads become sentences. Elaborations flow naturally. The organization remains, invisible.
...
Don't just see structure. See:
- What the author chose to emphasize
- Where they had lots to say (dense elaborations)
- Where they didn't (sparse or empty dashes)
- What semantic frame they're using (support/contrast/etc)

The structure reveals thinking, not just organization.

## loose vs tight

**loose deck** ⟜ honest about what you know
- shows natural emphasis
- gaps reveal sparse understanding
- semantic density visible

**tight deck** ⟜ performs completeness
- all slots filled
- may contain thin elaborations
- aesthetically pleasing but potentially misleading

Default to loose. Tighten only when content naturally fills the structure.
...
**prune** ⟜ remove fuzzy edges, preserve core meanings
**breathe** ⟜ place space for future elaborations
...
Decking is permissive by default. Structure guides but doesn't constrain. Let content determine form. Read both ways: compress prose into decks, expand decks into prose. Trust sparsity. Avoid forcing completeness. Stay flexible.
